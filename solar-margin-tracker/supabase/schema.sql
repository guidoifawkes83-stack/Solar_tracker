...
create table if not exists projects (
  ...
  -- misc / uncategorised budget line — present in the live schema but not yet
  -- wired into the margin formula or any UI. Defaults to 0 so it has no effect
  -- until it's actually used for something.
...
-- Present in the live schema but not yet wired into the margin formula or
-- any UI — currently empty and has no effect on any calculation.
